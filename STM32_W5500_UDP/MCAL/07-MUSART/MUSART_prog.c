...
volatile u8  uart_TxBufferIndex = 0;
volatile u8  uart_RxBufferIndex = 0;
...
void USART2_IRQHandler (void)
{
	...
	{
		uart_RxBUFFER[uart_RxBufferIndex] = USART_CH[MUSART2]->USART_DR ;
		MGPIO_enSetPinValue(PORTA, PIN4, HIGH);
